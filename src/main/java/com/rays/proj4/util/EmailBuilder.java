...
public class EmailBuilder {
	...
	//Email to user which are newly registered
	    /**
	    ...
	    //email to user who forget their password
	    /**
	    ...
	    public static String getForgetPasswordMessage(HashMap<String, String> map) {
	        ...
	        // msg.append("<P>To access account user login ID : " + map.get("login") + " and password " + map.get("password") + "</P>");
