...
//import vap.exception.ApplicationException;
//***********************need to confirm*************************************
...
public class EmailUtility {
	 ...
	 */
	static ResourceBundle rb = ResourceBundle.getBundle("bundle.system");
	// ***********************need to
	// confirm*************************************
	// email server
	/**
	...
	// factory session: connection duration with server
	/**
	 * Session Factory, A session is a connection to email server
	 */
	private static final String SSL_FACTORY = "javax.net.ssl.SSLSocketFactory";
	// Admin email id from where emails are sent
	/**
	...
	// properties to assign parameters
	/**
