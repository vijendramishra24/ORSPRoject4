...
public interface ORSView {
	...
	public String ERROR_CTL = APP_CONTEXT + "/ErrorCtl";// need to create errorctl and
													// error jsp
	...
	public String USER_REGISTRATION_CTL = APP_CONTEXT + "/UserRegistrationCtl";// need
																					// to
																					// remove
																					// ctl-->need
																					// not
